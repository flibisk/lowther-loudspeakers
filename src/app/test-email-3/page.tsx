...
export default function TestEmail3Page() {
  ...
  const handleSendTest = async () => {
    ...
    try {
      const response = await fetch('/api/test-abandoned-cart-email-3', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h1 className="text-2xl font-bold mb-4">Test Email 3: Final Call Email</h1>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="list-disc list-inside text-sm text-blue-800 space-y-1">
            ...
            <li>Or use the API directly: <code className="bg-blue-100 px-1 rounded">POST /api/test-abandoned-cart-email-3</code></li>
            <li>Or GET: <code className="bg-blue-100 px-1 rounded">/api/test-abandoned-cart-email-3?email=your-email@example.com</code></li>
