...
export function BuildALowtherBanner() {
  return (
    <section className="relative w-full h-[600px] overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <Image
          src="/images/hero/Build-a-lowther-banner.webp"
          alt="Build your Lowther - Premium loudspeakers for home builders"
          fill
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          <div className="max-w-lg text-white">
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="text-sm tracking-wider uppercase text-white/80">DOWNLOAD PLANS</span>
            </div>
